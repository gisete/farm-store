...
const Cart = ({ hideButton }: CartProps) => {
	...
	return (
		<>
			...
			>
				<div className="pt-16 md:pt-6 p-6 flex flex-col">
					<h2 className="text-center text-lg mb-6">Cabaz</h2>

					<button
						type="button"
						className="bg-white absolute top-4 right-4 p-4 inline-flex items-center justify-center text-black focus:outline-none focus:ring-2 focus:ring-inset w-[55px] h-[55px] rounded-full border border-black"
